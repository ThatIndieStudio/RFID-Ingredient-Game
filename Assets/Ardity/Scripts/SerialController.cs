...
public class SerialController : MonoBehaviour
{
    ...
    {
        //get the port
        //apiDataPath = apiDataPath + "/MoP-LoreBook";
        string progressdataPath;
        progressdataPath = path + "/Setup/comPortSetup.json";
         using (StreamReader streamReader = File.OpenText(progressdataPath))
        {
            string jsonString = streamReader.ReadToEnd();
            //portName = JsonUtility.FromJson<ComSetUpString>(jsonString).comSetup[0].comData;
            portName = jsonString;
        }
